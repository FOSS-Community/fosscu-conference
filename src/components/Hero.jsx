...
const Hero = () => {
  ...
  return (
    <div
      className="bg-[#000300] h-[40rem] md:h-[48rem] lg:h-[56rem] flex items-center relative" // Added relative positioning
      style={{
    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex flex-col justify-center items-center text-center h-full">
          ...
          <animated.div className="w-full  z-10 mt-44 cursor-grab" style={fadeIn}>
